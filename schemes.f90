...
!dicix6=0.
!cicix6=-0.0211727
!aicix6=1./16.*( 9.+10.*ailcaix6+16.*2.*cicix6)
!bicix6=1./16.*(-1.+ 6.*ailcaix6-24.*2.*cicix6)
! Ordre10
!ailcaix6=7./18.
!aicix6=0.5*1225./768.
!bicix6=0.5*49./256.
...
!diciy6=0.
!ciciy6=-0.0211727
!aiciy6=1./16.*( 9.+10.*ailcaiy6+16.*2.*ciciy6)
!biciy6=1./16.*(-1.+ 6.*ailcaiy6-24.*2.*ciciy6)
! Ordre10
!ailcaiy6=7./18.
!aiciy6=0.5*1225./768.
!biciy6=0.5*49./256.
...
!   diciz6=0.
!   ciciz6=-0.0211727
!   aiciz6=1./16.*( 9.+10.*ailcaiz6+16.*2.*ciciz6)
!   biciz6=1./16.*(-1.+ 6.*ailcaiz6-24.*2.*ciciz6)
   ! Ordre10
!   ailcaiz6=7./18.
!   aiciz6=0.5*1225./768.
!   biciz6=0.5*49./256.
