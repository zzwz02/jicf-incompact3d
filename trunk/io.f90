...
#include "io_write_plane.f90"
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ! Write a 2D slice of the 3D data to a file ---- only in recycling region
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#include "io_write_plane_re.f90"

    return
  end subroutine write_plane_3d_real_re
...
#include "io_write_plane_re.f90"
    ...
    return
  end subroutine write_plane_3d_complex_re
