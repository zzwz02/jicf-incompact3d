...
!module inflow
real(mytype), save, allocatable, dimension(:,:) :: bxx1,bxy1,bxz1,bxxn,bxyn,bxzn,bxo,byo,bzo,bto
...
real(mytype), save, allocatable, dimension(:,:,:) :: bxx11,bxx12,bxxn1,bxxn2
...
use decomp_2d, only : mytype
  integer :: nclx,ncly,nclz,print_flag,print_interval,njicf,ibm_y_max,diverge=0
  ...
  real(mytype) :: xlx,yly,zlz,dx,dy,dz,dx2,dy2,dz2,Re_tau,ujicf
